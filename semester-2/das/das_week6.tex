...
In Week 4's Lab we introduced regression modelling where we modeled the
relationship between an outcome variable y and a single explanatory
variable x. We only included one explanatory variable x, which was
either a continuous or a categorical variable. This week, we shall
examine fitting regression models with more than one explanatory
...
may consider an individual's level of education, and perhaps the wealth
